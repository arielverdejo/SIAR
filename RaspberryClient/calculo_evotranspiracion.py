...
Parametros = ([Altura,LatGrad,LatRad,dl,dr,delta,ws,sen_sen,cos_cos,Gsc,Ra,N,n,
               Rs_cal,Rs_real,Rso_despejado,Evaporacion,Sigma,Lambda,cp,Epsilon,
               Ganma,PA,PA_Atmos,TM_Atmos,Tm_Atmos,ea,HR_M_Atmos,HR_m_Atmos,
               es_TM,es_Tm,ea_M,ea_m,es_ea,Rs_Rso,Rnl,Rns,Rn_calc,Rn,G,
               AlturaAnem,uviento_Atmos,uvientocor,Delta_Mayuscula,Eto])
